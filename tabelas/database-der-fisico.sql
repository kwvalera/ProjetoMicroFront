...
ALTER TABLE OrdemServico ADD CONSTRAINT fk_os_endereco_busca
FOREIGN KEY (id_endereco_busca) REFERENCES Endereco(id_endereco);

ALTER TABLE OrdemServico ADD CONSTRAINT fk_os_endereco_entrega
...
ALTER TABLE OrdemServico ADD CONSTRAINT fk_os_atendente
FOREIGN KEY (id_atendente) REFERENCES Funcionario(id_funcionario);

ALTER TABLE OrdemServico ADD CONSTRAINT fk_os_tecnico
